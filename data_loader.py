...
class Data_loader(object):
    ...
    def fetch_data(self, inputs, outputs, idx_batch): # works for lsi --> lsi
...
if __name__ == '__main__':
    ...
    #batches = data_loader.create_batches(len(data_loader.Xs_lsi), batch_size=64)
    #input_batch, output_batch = data_loader.fetch_data(data_loader.Xs_lsi, data_loader.Ys_lsi, batches[0])
    ...
    print(Xs_ids[0])
    print([idx2word[i] for i in Xs_ids[0]])
